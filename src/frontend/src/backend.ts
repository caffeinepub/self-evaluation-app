...
export class Backend implements backendInterface {
    ...
    async getPastEvaluations(): Promise<Array<Evaluation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPastEvaluations();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitEvaluation(arg0: EvaluationInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEvaluation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
